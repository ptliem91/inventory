			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
						...
						<form name="shipServiceForm" ng-submit="checkOnSubmit($event, shipService)">
							<div class="card card-small">
								...
								<div class="card-body pt-0">								
									...
									<div class="form-group">
										...
										<input ng-model="shipService.name" ng-required="true"
											value="shipService.name" name="name" type="text"
											class="form-control required" id="name" />
									</div>
	
									<button ng-show="shipService.id != null" type="submit" class="btn btn-warning">
										<i class="fa fa-edit"></i> Update
									</button>
									
									<button ng-show="shipService.id == null" type="submit" class="btn btn-success">
